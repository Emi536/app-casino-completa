...
def preparar_dataframe(df):
    ...
    columnas_esperadas = [
        "ID", "Tipo", "Monto", "Monto_Retiro", "?2", "?3", "Saldo",
...
# SECCIÓN 3: REGISTRO
    ...
    if archivo:
        ...
        if df is not None:
            ...
            df["Monto_Retiro"] = pd.to_numeric(df["Monto_Retiro"].astype(str).str.replace(".", "", regex=False).str.replace(",", ".", regex=False), errors="coerce").fillna(0)
            ...
            for jugador in jugadores:
                ...
                if not cargas.empty:
                    ...
                    cantidad_retiro = retiros["Monto_Retiro"].sum()
